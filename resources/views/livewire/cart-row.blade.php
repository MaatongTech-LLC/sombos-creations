<tr class="tf-cart-item file-delete">
    <td class="tf-cart-item_product">
        <a href="{{ route('products', $item->product->id) }}" class="img-box">
        ...
        <div class="cart-info">
            ...
            <span class="remove-cart link remove" @click="$dispatch('deleteItem')">Remove</span>
        </div>
    </td>
    ...
    <td class="tf-cart-item_quantity" cart-data-title="Quantity">
        <div class="cart-quantity">
            <div class="wg-quantity">
                    <span class="btn-quantity btndecrease" @click="$dispatch('decrement')">
                ...
                <span class="btn-quantity btnincrease" @click="$dispatch('increment')">
