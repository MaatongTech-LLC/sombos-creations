...
@section('content')
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form class="form-add-product" action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="wg-box mb-30">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter title" name="name" tabindex="0" value="{{ $product->name }}" aria-required="true" required="">
                        @error('name')
                        ...
                        <div class="upload-image flex-grow">
                            <div class="up-load">
                                <label class="uploadfile h250" for="myFile">
                                    ...
                                    <img id="myFile-input" src="{{ $product->getImage() }}" alt="">
                    ...
                    <div class="gap-2 d-flex align-items-center">
                        <fieldset class="price">
                            ...
                            <input class="" type="number" placeholder="Price" name="price" tabindex="0" min="1" value="{{ $product->price }}" aria-required="true" required="">
                        </fieldset>
                        @error('price')
                        <div class="text-tiny text-danger">{{ $message }}</div>
                        @enderror
                        <fieldset class="stock">
                            ...
                            <input class="" type="number" placeholder="Enter Stock" name="stock" tabindex="0" value="{{ $product->stock }}" aria-required="true" required="">
                            @error('stock')
                            <div class="text-tiny text-danger">{{ $message }}</div>
                            @enderror
                        </fieldset>
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" placeholder="Short description about product" tabindex="0" aria-required="true" required="">{{ $product->description }}</textarea>
                        @error('description')
                        <div class="text-tiny text-danger">{{ $message }}</div>
                        @enderror
                    </fieldset>
